        ...
        <div className="flex flex-row items-center justify-between text-sm lg:justify-start">
          <Link href="/" className="flex items-center gap-2">
            ...
            <h4 className="text-3xl font-semibold ">
              Blog<span className="text-primary">Serdar</span>
            </h4>
          </Link>
      ...
      <section className="relative flex items-center justify-center">
        <div className="relative items-center w-full py-12 lg:py-20">
          <div className="text-center">
            ...
            <h1 className="mt-8 text-4xl sm:text-6xl md:text-7xl lg:text-8xl leading-none">
              Setup your Blog{" "}
          ...
          <div className="relative items-center w-full py-12 mx-auto mt-12">
            ...
            <Image src={HeroImage} alt="heroimage" className="relative object-cover w-full border rounded-lg shadow-2xl lg:rounded-2xl" priority />
          </div>
        </div>
      </section>
    </>
