    ...
    <div>
      ...
      {sites.length > 0 ? (
        ...
        <EmptyState
          ...
          description="You currently dont have any sites created. please create some so that you can see them right here "
      ...
      {articles.length > 0 ? (
        ...
        <EmptyState
          ...
          description="You currently dont have any articles created. please create some so that you can see them right here "
